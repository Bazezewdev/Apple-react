...
class Youtube extends Component {
  ...
  componentDidMount() {
    fetch(
      ...
      "https://www.googleapis.com/youtube/v3/search?key=AIzaSyBK0qQNpvNhHd7HOpN9Fvmm9vNaOKScRN4&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=6"
    )
